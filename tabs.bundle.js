...
const getHeartParticle = () => document.getElementById("heart-particle");
...
getHeartParticle().addEventListener("animationstart", function heartParticleInit() {
    getHeartParticle().ariaHidden = "false";
    getHeartParticle().alt = "effect of the dog liking the food";
});
getHeartParticle().addEventListener("animationend", function heartParticleEnd() {
