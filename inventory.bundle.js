...
/* harmony import */ var _soundController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../soundController */ "./src/inventory/soundController.ts");
/* harmony import */ var _cell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cell */ "./src/inventory/cells/cell.ts");
var __classPrivateFieldGet = (undefined && undefined.__classPrivateFieldGet) || function (receiver, state, kind, f) {
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a getter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot read private member from an object whose class did not declare it");
    return kind === "m" ? f : kind === "a" ? f.call(receiver) : f ? f.value : state.get(receiver);
...
class emptyCell extends _cell__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor() {
        super();
        ...
        this.cellDragDrop = (event) => {
            ...
            (0,_soundController__WEBPACK_IMPORTED_MODULE_1__.getEquipSound)().play();
...
/* harmony import */ var _soundController__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../soundController */ "./src/inventory/soundController.ts");
/* harmony import */ var _cell__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cell */ "./src/inventory/cells/cell.ts");
/* harmony import */ var _emptyCell__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./emptyCell */ "./src/inventory/cells/emptyCell.ts");
var __classPrivateFieldSet = (undefined && undefined.__classPrivateFieldSet) || function (receiver, state, value, kind, f) {
    if (kind === "m") throw new TypeError("Private method is not writable");
    if (kind === "a" && !f) throw new TypeError("Private accessor was defined without a setter");
    if (typeof state === "function" ? receiver !== state || !f : !state.has(receiver)) throw new TypeError("Cannot write private member to an object whose class did not declare it");
...
class mealCell extends _cell__WEBPACK_IMPORTED_MODULE_2__["default"] {
    constructor(src, satiety) {
        ...
        this.cellProgressClick = () => {
            ...
            const newCell = new _emptyCell__WEBPACK_IMPORTED_MODULE_3__["default"]();
            (0,_soundController__WEBPACK_IMPORTED_MODULE_1__.getEatSound)().play();
            ...
            if (!(0,_db__WEBPACK_IMPORTED_MODULE_0__.getStoreMeals)().length && !(0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeals)().length) {
                document.getElementById("getfood").dataset.task = "completed";
            }
        };
        this.cellSelectClick = (event) => {
            const getSwapBtn = () => document.getElementById("swap-btn");
            if (this.cell.dataset.select) {
                if (this.cell.parentElement.dataset.type !== "store")
                    return;
                (0,_soundController__WEBPACK_IMPORTED_MODULE_1__.getSelectSound)().play();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   characterInit: () => (/* binding */ characterInit)
/* harmony export */ });
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../db */ "./src/db/index.ts");
/* harmony import */ var _cells__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cells */ "./src/inventory/cells/index.ts");
/* harmony import */ var _soundController__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./soundController */ "./src/inventory/soundController.ts");
...
function characterDragOver(event) {
    event.preventDefault();
    event.dataTransfer.dropEffect = "move";
    if (getProgress().value <= 0 || getProgress().value >= 100)
        return;
    (0,_soundController__WEBPACK_IMPORTED_MODULE_2__.getMeowSound)().play();
}
function characterDragDrop(event) {
    const getId = () => event.dataTransfer.getData("element/id");
    if ((0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).cell.parentElement.dataset.type === "store")
        return;
    if ((0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).cell.closest(".content-wrapper").id !== "pet")
        return;
    if (getProgress().value <= 0 || getProgress().value >= 100)
        return;
    getProgress().value += (0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).satiety;
    const initPos = (0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).positionIndex;
    const newCell = new _cells__WEBPACK_IMPORTED_MODULE_1__.emptyCell();
    (0,_soundController__WEBPACK_IMPORTED_MODULE_2__.getEatSound)().play();
    (0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).cell.replaceWith(newCell.setPositionIndex(parseInt(initPos)).setAttributes().cell);
    newCell.setParent();
    (0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeals)().splice((0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeals)().indexOf((0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)((0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeal)(getId()).id)), 1);
    const getFoodTask = () => document.getElementById("getfood");
    if (!(0,_db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeals)().length && getFoodTask().dataset.task === "completed") {
        document.getElementById("getfood").dataset.task = "not-completed";
    }
    if (getProgress().value >= 100) {
        if (getFoodTask().dataset.task === "not-completed") {
...
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../db */ "./src/db/index.ts");
/* harmony import */ var _cells__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cells */ "./src/inventory/cells/index.ts");
/* harmony import */ var _character__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./character */ "./src/inventory/character.ts");
/* harmony import */ var _inventory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./inventory */ "./src/inventory/inventory.ts");
/* harmony import */ var _soundController__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./soundController */ "./src/inventory/soundController.ts");
...
const storeInventory = new _inventory__WEBPACK_IMPORTED_MODULE_3__.inventoryWithItems("store", _db__WEBPACK_IMPORTED_MODULE_0__.getStoreMeals)
    .appendTo(storeContentWrapper())
    .classList("inventory")
    .setId("left-menu-section");
const visitorInventorySt = new _inventory__WEBPACK_IMPORTED_MODULE_3__.inventoryWithItems("visitor", _db__WEBPACK_IMPORTED_MODULE_0__.getVisitorMeals)
    .appendTo(storeContentWrapper())
    .classList("inventory");
const getSwapBtn = () => document.getElementById("swap-btn");
...
function init() {
    ...
    (0,_character__WEBPACK_IMPORTED_MODULE_2__.characterInit)();
    ...
    if ((0,_db__WEBPACK_IMPORTED_MODULE_0__.getSwapMeals)().length && getEmptyCell()) {
        (0,_db__WEBPACK_IMPORTED_MODULE_0__.getSwapMeals)().forEach((meal) => {
            ...
            const mealElement = () => meal
                ...
                .setAttributes().cell;
            const newCell = new _cells__WEBPACK_IMPORTED_MODULE_1__.emptyCell();
            (0,_soundController__WEBPACK_IMPORTED_MODULE_4__.getEquipSound)().play();
            mealElement().replaceWith(newCell.setPositionIndex(parseInt(initPos)).setAttributes().cell);
            newCell.setParent();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,